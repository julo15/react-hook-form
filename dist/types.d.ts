...
export declare type FieldName<FormValues extends FieldValues> =
  | (keyof FormValues & string)
  | string;
export declare type FieldValue<
  FormValues extends FieldValues
> = FormValues[FieldName<FormValues>];
...
export declare type OnSubmit<FormValues extends FieldValues> = (
  data: FormValues,
...
declare type ValidationOptionObject<Value> =
  | Value
  | {
      value: Value;
      message: string;
...
export declare type FieldRefs<FormValues extends FieldValues> = Partial<
...
export declare type FormStateProxy<
  FormValues extends FieldValues = FieldValues
> = {
  dirty: boolean;
...
export declare type ElementLike = {
  name: string;
  type?: string;
  value?: string;
  checked?: boolean;
...
export declare type FormValuesFromErrors<Errors> = Errors extends FieldErrors<
  infer FormValues
>
  ? FormValues
  : never;
...
export declare type AsProps<As> = As extends undefined
  ? {}
...
export declare type UseFieldArrayProps<
